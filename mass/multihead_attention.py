...
class MultiheadAttention(nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, kdim=None, vdim=None, dropout=0., bias=True,
                 ...
                 encoder_decoder_attention=False, tgt_types=None, enable_torch_version=None):
        super().__init__()
        ...
        if tgt_types is not None and isinstance(tgt_types, dict) and len(tgt_types) > 1:
            self.q_proj = nn.ModuleList([nn.Linear(embed_dim, embed_dim, bias=bias) for _ in range(len(tgt_types))])
